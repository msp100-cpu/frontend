...
import { clearData, storeAuthData } from "../../Redux/actions/userAction";
...
const Login = (props) => {
  ...
  return (
    <div className="bg-gray-50 mx-auto">
      <div className="flex flex-col justify-center py-12 my-auto px-2">
        <div
          className={
            props.modal
              ? "mx-auto p-2 md:p-5 rounded-lg w-full max-w-2xl"
              : "mx-auto md:shadow-xl p-2 md:p-5 rounded-lg w-full max-w-lg"
          }
        >
          <div>
